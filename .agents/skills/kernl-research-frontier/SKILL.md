...
| Diagnostics scripts and artifact scope | `Get-ChildItem .Codex/skills/kernl-diagnostics-and-tooling/scripts; python .Codex/skills/kernl-diagnostics-and-tooling/scripts/brain_audit.py backend/tests/last_compiled_brain.json` |
