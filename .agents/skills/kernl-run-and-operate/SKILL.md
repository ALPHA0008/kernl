...
**Jargon (defined once):**
- **Brain / skills file** — the compiled JSON output of the pipeline: `{skills, graph_json, metadata_json, meta}` (backend/engine/nodes/write_brain.py:41-53). "Skills" here are structured policy rules, not Codex skills.
