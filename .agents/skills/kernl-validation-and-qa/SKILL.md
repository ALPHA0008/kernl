...
From the master plan (`docs/archive/operational-graph-master-plan.md [doc removed 2026-07-13; historical citation]:1386-1395`). **These are the design doc's targets, NOT current reality** — today's full-pipeline strict accuracy is 15.0% (§3):
...
| Master-plan targets table | `grep -n "90% relaxed" docs/archive/operational-graph-master-plan.md [doc removed 2026-07-13; historical citation]` (≈ line 1390) |
