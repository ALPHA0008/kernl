...
CLAUDE.md:429-438 lists the 12 intended skills per department; the committed brain indeed contains 12 skills (ids like `refund_policy_matrix`, `discount_authority_matrix`, `p0_bug_enterprise_response`) and 21 graph policies. The eval baseline against all of this: strict 15.0%, relaxed 52.5%, rule-hit 55.0% (eval_results_baseline.json:10-12) — the gap is the over-ambiguity failure of section 5.
